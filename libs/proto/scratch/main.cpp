  ...
  , proto::expr_subscript<lambda_expr<Tag, Args>, lambda_domain>
{
    ...
    BOOST_PROTO_AUTO_RETURN(
        algo::lambda_eval_(proto::utility::make_indices<0, sizeof...(T)>(), *this, std::forward<T>(t)...)
    )
};
...
{
    std::cout << "*** \n";
    std::cout << "*** This program demonstrates how to build a lambda library with Proto.\n";
    std::cout << "*** \n";
