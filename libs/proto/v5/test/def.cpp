...
static_assert(!proto::is_grammar<proto::fold(_, int(), proto::_state)>::value, "");
static_assert(proto::is_action<proto::fold(_, int(), proto::_state)>::value, "");
