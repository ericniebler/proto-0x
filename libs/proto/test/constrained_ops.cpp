...
struct extension
  : proto::basic_expr<Tag, Args, my_domain>
{
    BOOST_PROTO_REGULAR_TRIVIAL_CLASS(extension);
    typedef proto::basic_expr<Tag, Args, my_domain> proto_basic_expr_type;
...
template<class Tag, typename Args>
struct lhs_extension
  : proto::basic_expr<Tag, Args, my_lhs_domain>
{
    BOOST_PROTO_REGULAR_TRIVIAL_CLASS(lhs_extension);
    typedef proto::basic_expr<Tag, Args, my_lhs_domain> proto_basic_expr_type;
    BOOST_PROTO_INHERIT_EXPR_CTORS(lhs_extension, proto_basic_expr_type);
};

template<class Tag, typename Args>
struct rhs_extension
  : proto::basic_expr<Tag, Args, my_rhs_domain>
{
    BOOST_PROTO_REGULAR_TRIVIAL_CLASS(rhs_extension);
    typedef proto::basic_expr<Tag, Args, my_rhs_domain> proto_basic_expr_type;
