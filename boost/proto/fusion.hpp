    ...
    namespace fusion
    {
        namespace extension
        {
            ...
            struct next_impl<proto::tag::proto_expr_iterator>
            {
                template<typename Iterator>
                struct apply
                  : advance_impl<proto::tag::proto_expr_iterator>::template apply<
                        Iterator
...
namespace boost
{
    namespace mpl
    {
        ...
        struct sequence_tag<proto::expr<Tag, Args, Domain>>
        {
            typedef fusion::fusion_sequence_tag type;
        };

        template<typename Tag, typename Args, typename Domain>
        struct sequence_tag<proto::basic_expr<Tag, Args, Domain>>
        {
            typedef fusion::fusion_sequence_tag type;
        };
    }
