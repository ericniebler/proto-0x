...
#ifndef BOOST_PROTO_V5_MATCHES_HPP_INCLUDED
#define BOOST_PROTO_V5_MATCHES_HPP_INCLUDED
...
namespace boost
{
    namespace proto
    {
        inline namespace v5
        {
            ...
            /// \brief For determining whether an expression matches a grammar.
            ///
            template<typename Expr, typename Grammar>
            constexpr bool matches() noexcept
            {
                return result_of::matches<Expr, Grammar>::value;
            }
        }
    }
}

#endif // BOOST_PROTO_V5_MATCHES_HPP_INCLUDED
