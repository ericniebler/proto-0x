...
#ifndef BOOST_PROTO_V5_GRAMMAR_AND_HPP_INCLUDED
#define BOOST_PROTO_V5_GRAMMAR_AND_HPP_INCLUDED
        ...
        inline namespace v5
        {
            namespace extension
            {
                ...
                struct grammar_impl<proto::v5::and_(BoolActions...)>
                {
                    ...
                    using apply = utility::and_<detail::eval_bool_action_<BoolActions, Expr>...>;
                };
            }
        }
    }
