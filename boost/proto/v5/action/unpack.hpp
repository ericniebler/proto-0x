...
#ifndef BOOST_PROTO_V5_ACTION_UNPACK_HPP_INCLUDED
#define BOOST_PROTO_V5_ACTION_UNPACK_HPP_INCLUDED
    ...
    namespace proto
    {
        inline namespace v5
        {
            namespace detail
            {
                ...
                {
                    using type = proto::v5::_child<I>(Action);
                };

                template<typename Action>
                struct expand_pattern_2_<(std::size_t)-1, pack(Action)>
                {
                    using type = proto::v5::_value(Action);
                };
                ...
                {
                    using type = void(Actions..., Action);
                };
                ...
                {
                    using arity = result_of::arity_of<decltype(call_action_<Head>()(std::declval<Args>()...))>;
