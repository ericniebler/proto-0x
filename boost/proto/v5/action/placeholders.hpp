...
#ifndef BOOST_PROTO_V5_ACTION_PLACEHOLDERS_HPP_INCLUDED
#define BOOST_PROTO_V5_ACTION_PLACEHOLDERS_HPP_INCLUDED
    ...
    namespace proto
    {
        inline namespace v5
        {
              ...
              : basic_action<_state>
            {
                ...
                constexpr auto operator()(E &&, Env &&, S && s, Rest &&...) const
                BOOST_PROTO_AUTO_RETURN(
                    static_cast<S &&>(s)
                )
            };
