...
#include <boost/proto/v5/unpack_expr.hpp>
        ...
        inline namespace v5
        {
            ...
            namespace functional
            {
                ...
                struct flatten
                {
                    ...
                    struct result<This(Expr &)>
                    {
                        using type = proto::v5::detail::flat_view<Expr>;
                    };

                    template<typename Expr>
                    proto::v5::detail::flat_view<Expr> operator ()(Expr &e) const
                    {
                        return proto::v5::detail::flat_view<Expr>(e);
                    }

                    template<typename Expr>
                    proto::v5::detail::flat_view<Expr const> operator ()(Expr const &e) const
                    {
                        return proto::v5::detail::flat_view<Expr const>(e);
                    }
                };
            }
            ...
            /// <tt>((a | b) | c)</tt>.
            template<typename Expr>
            proto::v5::detail::flat_view<Expr> flatten(Expr &e)
            {
                return proto::v5::detail::flat_view<Expr>(e);
            }
            ...
            ///
            template<typename Expr>
            proto::v5::detail::flat_view<Expr const> flatten(Expr const &e)
            {
                return proto::v5::detail::flat_view<Expr const>(e);
            }
        }
...
namespace boost
{
    namespace fusion
    {
        namespace extension
        {
            ...
            template<typename Tag, typename Domain>
            struct deref_impl<proto::v5::proto_expr_iterator<Tag, Domain>>
            {
                template<
                    typename Iterator
                  , std::size_t Arity = proto::v5::result_of::arity_of<typename Iterator::expr_type>::value
                >
                struct apply
                {
                    using type =
                        typename proto::v5::result_of::child<
                    ...
                    {
                        return proto::v5::child<(std::size_t)Iterator::index>(iter.expr_);
                    }
                };
                ...
                {
                    using type =
                        typename proto::v5::result_of::value<
                            typename Iterator::expr_type &
                        >::type;

                    static type call(Iterator const &iter)
                    {
                        return proto::v5::value(iter.expr_);
                    }
                };
            };
            ...
            template<typename Tag, typename Domain>
            struct advance_impl<proto::v5::proto_expr_iterator<Tag, Domain>>
            {
            ...
            template<typename Tag, typename Domain>
            struct next_impl<proto::v5::proto_expr_iterator<Tag, Domain>>
            {
                template<typename Iterator>
                struct apply
                  : advance_impl<proto::v5::proto_expr_iterator<Tag, Domain>>::template apply<
                        Iterator
            ...
            template<typename Tag, typename Domain>
            struct prior_impl<proto::v5::proto_expr_iterator<Tag, Domain>>
            {
                template<typename Iterator>
                struct apply
                  : advance_impl<proto::v5::proto_expr_iterator<Tag, Domain>>::template apply<
            ...
            template<typename Tag, typename Domain>
            struct category_of_impl<proto::v5::proto_expr<Tag, Domain>>
            {
                template<typename Sequence>
                struct apply
                {
            ...
            template<typename Tag, typename Domain>
            struct begin_impl<proto::v5::proto_expr<Tag, Domain>>
            {
                template<typename Sequence>
                struct apply
                {
            ...
            template<typename Tag, typename Domain>
            struct end_impl<proto::v5::proto_expr<Tag, Domain>>
            {
                template<typename Sequence>
                struct apply
                {
            ...
            template<typename Tag, typename Domain>
            struct at_impl<proto::v5::proto_expr<Tag, Domain>>
            {
                template<
                    typename Sequence
                  , typename Index
                  , std::size_t Arity = proto::v5::result_of::arity_of<Sequence>::value
                >
                struct apply
                {
                    using type =
                    ...
                    static type call(Sequence &seq)
                    {
                        return proto::v5::child<(std::size_t)Index::value>(seq);
                    }
                };
            ...
            template<typename Tag, typename Domain>
            struct convert_impl<proto::v5::proto_expr<Tag, Domain>>
            {
                template<typename Sequence>
                struct apply
                {
                    using type =
                        typename proto::v5::result_of::unpack_expr<
                            Tag
                          , Sequence &
                          , Domain
                        >::type;
                    ...
                    static type call(Sequence& seq)
                    {
                        return proto::v5::unpack_expr<Tag, Domain>(seq);
                    }
                };
            };

            template<typename Tag, typename Domain>
            struct convert_impl<proto::v5::proto_flat_view<Tag, Domain>>
            {
                template<typename Sequence>
                struct apply
                {
            ...
            template<typename Tag, typename Domain>
            struct segments_impl<proto::v5::proto_flat_view<Tag, Domain>>
            {
                template<typename Sequence>
                struct apply
                {
            ...
            template<typename Tag, typename Domain>
            struct category_of_impl<proto::v5::proto_flat_view<Tag, Domain>>
            {
                template<typename Sequence>
                struct apply
                {
        ...
        namespace traits
        {
            ...
            struct enable_equality<
              ...
              , typename std::enable_if<
                    proto::v5::is_expr<Seq1>::value ||
                    proto::v5::is_expr<Seq2>::value
                >::type
            >
                : std::false_type
            {};
...
namespace boost
{
    namespace mpl
    {
        ...
        struct sequence_tag<proto::v5::exprs::expr<ExprDesc, Domain>>
        {
            using type = fusion::fusion_sequence_tag;
        };

        template<typename ExprDesc, typename Domain>
        struct sequence_tag<proto::v5::exprs::basic_expr<ExprDesc, Domain>>
        {
            using type = fusion::fusion_sequence_tag;
        };
    }
