...
#ifndef BOOST_PROTO_CXX11_DETAIL_COMMON_DOMAIN_HPP_INCLUDED
#define BOOST_PROTO_CXX11_DETAIL_COMMON_DOMAIN_HPP_INCLUDED
...
# define BOOST_PROTO_ASSERT_VALID_DOMAIN(DOM)                                                       \
    static_assert(!std::is_same<DOM, ::boost::proto::v5::detail::not_a_domain>::value, "no common domain!")
#endif
        ...
        inline namespace v5
        {
            namespace detail
            {
                ...
                template<
                    typename D0
                  , typename D1
                  , std::size_t DefaultCase = sizeof(proto::v5::detail::default_test((domain_<D0>*)0, (domain_<D1>*)0))
                >
...
#endif // BOOST_PROTO_CXX11_DETAIL_COMMON_DOMAIN_HPP_INCLUDED
