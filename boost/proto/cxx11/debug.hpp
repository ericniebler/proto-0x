...
#ifndef BOOST_PROTO_CXX11_DEBUG_HPP_INCLUDED
...
namespace boost
{
    namespace proto
    {
        inline namespace cxx11
        {
            ...
            namespace detail
            {
                struct display_expr_
                {
                    ...
                    void operator()(E const &e) const
                    {
                        ...
                        this->sout_ << tag() << "(" << proto::cxx11::value(e) << ")\n";
                        this->first_ = false;
                    }
            ...
            {
                static_assert(
                    proto::cxx11::matches<E, Grammar>::value
            ...
            #define BOOST_PROTO_ASSERT_MATCHES(E, Grammar)                                          \
                (true ? (void)0 : boost::proto::cxx11::assert_matches<Grammar>(E))
            ...
            #define BOOST_PROTO_ASSERT_MATCHES_NOT(E, Grammar)                                      \
                (true ? (void)0 : boost::proto::cxx11::assert_matches_not<Grammar>(E))
        }
    }
}
