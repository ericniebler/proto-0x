    ...
    namespace proto
    {
        inline namespace cxx11
        {
            namespace detail
            {
                ...
                template<typename Tag>
                struct tag_matches<Tag, proto::cxx11::_>
                  : std::true_type
                {};
                ...
                template<typename T, std::size_t M>
                struct array_matches<T[M], T[proto::cxx11::N]>
                  : std::true_type
                {};
                ...
                template<typename T>
                struct lambda_matches<T, proto::cxx11::_>
                  : std::true_type
                {};
                ...
                template<typename T, std::size_t M>
                struct lambda_matches<T[M], proto::cxx11::_>
                  : std::true_type
                {};
                ...
                template<typename T, std::size_t M>
                struct value_matches_<T(&)[M], T(&)[proto::cxx11::N]>
                  : std::true_type
                {};
                ...
                template<typename T>
                struct value_matches_<T, proto::cxx11::_>
                  : std::true_type
                {};
