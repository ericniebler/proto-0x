...
#include <boost/proto/cxx11/detail/compressed_pair.hpp>
        ...
        inline namespace cxx11
        {
            namespace detail
            {
                ...
                public:
                    ...
                    BOOST_PROTO_RETURN(
                        proto::cxx11::child<0>(static_cast<exprs::basic_expr<equal_to(T, U), Domain> const &>(*this)).proto_equal_to(
                        proto::cxx11::child<1>(static_cast<exprs::basic_expr<equal_to(T, U), Domain> const &>(*this)))
                ...
                public:
                    inline operator unspecified_bool_type() const
                    BOOST_PROTO_RETURN(
                        proto::cxx11::child<0>(static_cast<exprs::basic_expr<not_equal_to(T, U), Domain> const &>(*this)).proto_equal_to(
                        proto::cxx11::child<1>(static_cast<exprs::basic_expr<not_equal_to(T, U), Domain> const &>(*this)))
                ...
                public:
                    inline operator unspecified_bool_type() const
                    BOOST_PROTO_RETURN(
                        proto::cxx11::child<0>(static_cast<exprs::basic_expr<logical_not(T), Domain> const &>(*this))
                        ? 0 : &proto_smart_bool::member
                    )
                };
                ...
                public:
                    inline operator unspecified_bool_type() const
                    BOOST_PROTO_RETURN(
                        static_cast<bool>(proto::cxx11::child<0>(static_cast<exprs::basic_expr<logical_and(T, U), Domain> const &>(*this))) &&
                        static_cast<bool>(proto::cxx11::child<1>(static_cast<exprs::basic_expr<logical_and(T, U), Domain> const &>(*this)))
                        ? &proto_smart_bool::member : 0
                    )
                };
                ...
                public:
                    inline operator unspecified_bool_type() const
                    BOOST_PROTO_RETURN(
                        static_cast<bool>(proto::cxx11::child<0>(static_cast<exprs::basic_expr<logical_or(T, U), Domain> const &>(*this))) ||
                        static_cast<bool>(proto::cxx11::child<1>(static_cast<exprs::basic_expr<logical_or(T, U), Domain> const &>(*this)))
                        ? &proto_smart_bool::member : 0
                    )
                };
            ...
            #define BOOST_PROTO_INHERIT_EXPR_CTORS(EXPR, BASE)                                      \
                ...
                template<typename proto_A_                                                          \
                  , BOOST_PROTO_ENABLE_IF(                                                          \
                        ...
                        !(boost::proto::cxx11::utility::is_base_of<EXPR, proto_A_>::value)                 \
                    )                                                                               \
                >                                                                                   \
            ...
            namespace result_of
            {
                ...
                struct child
                {
                    using type = decltype(proto::cxx11::child<N>(std::declval<Expr>()));
                };

                template<typename Expr>
                struct left
                {
                    using type = decltype(proto::cxx11::left(std::declval<Expr>()));
                };

                template<typename Expr>
                struct right
                {
                    using type = decltype(proto::cxx11::right(std::declval<Expr>()));
                };

                template<typename Expr>
                struct value
                {
                    using type = decltype(proto::cxx11::value(std::declval<Expr>()));
                };
            }
