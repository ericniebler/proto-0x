...
#ifndef BOOST_PROTO_CXX11_FWD_HPP_INCLUDED
#define BOOST_PROTO_CXX11_FWD_HPP_INCLUDED
...
#define BOOST_PROTO_AUTO_RETURN(...)                                                                \
    noexcept(noexcept(                                                                              \
        decltype(__VA_ARGS__)(boost::proto::cxx11::utility::move_declval<decltype(__VA_ARGS__)>())  \
...
#define BOOST_PROTO_ENABLE_IF(...)                                                                  \
    typename std::enable_if<static_cast<bool>(__VA_ARGS__)>::type *& = boost::proto::cxx11::detail::enabler

// New-style enable_if from Matt Calabrese
#define BOOST_PROTO_ENABLE_IF_VALID_EXPR(...)                                                       \
    decltype(static_cast<void>(__VA_ARGS__)) *& = boost::proto::cxx11::detail::enabler
...
#define BOOST_PROTO_IGNORE_UNUSED(...)                                                              \
    ...
    {                                                                                               \
        (boost::proto::cxx11::utility::ignore(__VA_ARGS__), 0)                                      \
    }                                                                                               \
    /**/
