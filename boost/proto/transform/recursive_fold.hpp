    ...
    namespace proto
    {
        namespace detail
        {
            ...
            struct _recursive_fold_
              : unprotected::if_<_has_tag<Tag>, unprotected::_fold<_, _state, _recursive_fold_<Tag, Fun>>, Fun>
            {};

            template<typename Tag, typename Fun>
            struct _reverse_recursive_fold_
              : unprotected::if_<_has_tag<Tag>, unprotected::_reverse_fold<_, _state, _reverse_recursive_fold_<Tag, Fun>>, Fun>
            {};
        }
